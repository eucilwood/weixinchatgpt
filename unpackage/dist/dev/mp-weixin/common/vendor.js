...
const y = true, _ = "mp-weixin", v = m([]), S = _, k = m('{\n    "address": [\n        "127.0.0.1",\n        "192.168.31.121"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "I:/googledownload/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), I = m('[{"provider":"aliyun","spaceName":"eren","spaceId":"mp-b2887b51-8959-46ce-82bc-96df5e4791b2","clientSecret":"1nPhHjyuvkwurs6rcm9VXw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let T = "";
try {
  T = "__UNI__BA790C7";
} catch (e2) {
